...
const Notification = ({
  ...
  const colorClasses = {
    ...
    orange: 'border-orange-600 bg-orange-100 text-orange-600',
  };
  ...
  return (
    <p
      className={`border-2 ${colorClasses[color]} rounded-lg p-2 mb-0 text-center ${fontStyle} ${textSize} align-middle`}
    >
